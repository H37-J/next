                    ...
                    <ul className="space-y-2 font-medium">
                        <li className="relative">
                            ...
                            <div id="webDropdown"
                                ...
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200 border-s border-gray-700"
                                    aria-labelledby="doubleDropdownButton">
                                    <li>
                                        <a href="#"
                                           className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">APi
                                            테스트</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">크롤링</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">이미지</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li className="relative">
                            ...
                            <div id="algoDropdown"
                                ...
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200 border-s border-gray-700"
                                    ...
                                    <li>
                                        <a href="#"
                                           className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Java</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">JavaScript</a>
                                    </li>
